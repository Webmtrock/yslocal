...
function switcherClick() {
    ...
    let boxedVar = boxedBtn.addEventListener('click', () => {
        if(localStorage.zanexlayout =='horizontal'){
            document.querySelector("#switcher-horizontal").click()
        }
        html.setAttribute('data-width', 'boxed');
        localStorage.setItem("zanexboxed", true);
    ...
    let shadowVar = regular.addEventListener('click', () => {
        ...
        localStorage.setItem("zanexregular", true);
    ...
    let noShadowVar = classic.addEventListener('click', () => {
        ...
        localStorage.setItem("zanexclassic", true);
    ...
    let modernVar = modern.addEventListener('click', () => {
        ...
        localStorage.setItem("zanexmodern", true);
        localStorage.removeItem("zanexregular");
        localStorage.removeItem("zanexclassic");
    });
    ...
    let verticalVar = verticalBtn.addEventListener('click', () => {
        ...
        // local storage
        localStorage.removeItem("zanexlayout");
...
function lightFn() {
    ...
    localStorage.removeItem("zanexbgColor");
    localStorage.removeItem("zanexheaderbg");
    localStorage.removeItem("zanexbgwhite");
    localStorage.removeItem("zanexmenubg");
    localStorage.removeItem("zanexmenubg");
    checkOptions();
...
function horizontalClickFn() {
    ...
    if(!localStorage.zanexMenu && !localStorage.bodylightRGB){
        html.setAttribute("data-menu-styles","light")
        document.querySelector('#switcher-menu-light').checked = true;
        checkOptions();
    }
...
function checkOptions() {
    ...
    // light header
    if (localStorage.getItem('zanexHeader') === "light") {
        document.querySelector('#switcher-header-light').checked = true;
    }

    // color header
    if (localStorage.getItem('zanexHeader') === "color") {
        document.querySelector('#switcher-header-primary').checked = true;
    }

    // gradient header
    if (localStorage.getItem('zanexHeader') === "gradient") {
        document.querySelector('#switcher-header-gradient').checked = true;
    }

    // dark header
    if (localStorage.getItem('zanexHeader') === "dark") {
        document.querySelector('#switcher-header-dark').checked = true;
    }
    // transparent header
    if (localStorage.getItem('zanexHeader') === "transparent") {
        document.querySelector('#switcher-header-transparent').checked = true;
    }

    // light menu
    if (localStorage.getItem('zanexMenu') === 'light') {
        document.querySelector('#switcher-menu-light').checked = true;
    }

    // color menu
    if (localStorage.getItem('zanexMenu') === 'color') {
        document.querySelector('#switcher-menu-primary').checked = true;
    }

    // gradient menu
    if (localStorage.getItem('zanexMenu') === 'gradient') {
        document.querySelector('#switcher-menu-gradient').checked = true;
    }

    // dark menu
    if (localStorage.getItem('zanexMenu') === 'dark') {
        document.querySelector('#switcher-menu-dark').checked = true;
    }
    // transparent menu
    if (localStorage.getItem('zanexMenu') === 'transparent') {
        document.querySelector('#switcher-menu-transparent').checked = true;
    }

    //boxed
    if (localStorage.getItem('zanexboxed')) {
        document.querySelector('#switcher-boxed').checked = true;
    }

    //scrollable
    if (localStorage.getItem('zanexheaderscrollable')) {
        document.querySelector('#switcher-header-scroll').checked = true;
    }
    if (localStorage.getItem('zanexmenuscrollable')) {
        document.querySelector('#switcher-menu-scroll').checked = true;
    }

    //fixed
    if (localStorage.getItem('zanexheaderfixed')) {
        document.querySelector('#switcher-header-fixed').checked = true;
    }
    if (localStorage.getItem('zanexmenufixed')) {
        document.querySelector('#switcher-menu-fixed').checked = true;
    }

    //classic
    if (localStorage.getItem('zanexclassic')) {
        document.querySelector('#switcher-classic').checked = true;
    }

    //modern
    if (localStorage.getItem('zanexmodern')) {
