...
(() => {
  ...
  if (
    !localStorage.getItem("zanexlayout") &&
    !localStorage.getItem("zanexnavstyles") &&
    !localStorage.getItem("zanexverticalstyles") &&
      ...
      switch (verticalStyle) {
        ...
        case "overlay":
          ...
          if (html.getAttribute('data-toggled') === 'icon-overlay-close') {
            ...
            if (window.innerWidth >= 992) {
              if (!localStorage.getItem("zanexlayout")) {
...
function doubletFn() {
  ...
  tooltip.style.setProperty("margin-inline-start", "52px");
