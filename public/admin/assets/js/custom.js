(function () {
  ...
  function toggleTheme() {
    ...
    if (html.getAttribute("data-theme-mode") === "dark") {
      ...
      document.querySelector("#switcher-background1").checked = false;
      document.querySelector("#switcher-background").checked = false;
      localStorage.setItem("zanexdarktheme", "true");
...
headerbtn1.forEach((button) => {
  button.addEventListener("click", (e) => {
    ...
    document.getElementById("notifiation-data").innerText = `${document.querySelectorAll(".dropdown-item-close2").length
      } Unread`;
    if (document.getElementById("notification-icon-badge")) {
      document.getElementById("notification-icon-badge").innerText = `${document.querySelectorAll(".dropdown-item-close2").length
        }`;
    }
...
headerbtn2.forEach((button) => {
  button.addEventListener("click", (e) => {
    ...
    e.stopPropagation();
    button.parentNode.parentNode.parentNode.parentNode.remove();
    document.getElementById("message-data").innerText = `${document.querySelectorAll(".dropdown-item-close3").length
      } Unread`;
    if (document.getElementById("notification-icon-badge")) {
      document.getElementById("notification-icon-badge").innerText = `${document.querySelectorAll(".dropdown-item-close3").length
        }`;
    }
