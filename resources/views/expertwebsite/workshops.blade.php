        ...
        <!--- Popular program-->
         <div class="program-popular page-section" style="  background: #0EA89D;" >
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                  <div style="    color: #fff;">Home > Workshops</div>
                <h2 class="ys-headting" style="    color: #fff;">Explore Workshops</h2>  
                   ...
                   @foreach($wibiner as $key => $value)
                    <div class="popular-program-list">
                      <div class="prog-list row">
                        ...
                        <a href="{{ route('expert.website.workshop', ['id' => $value->id]) }}"> 
                       <img src="{{ url(config('app.webinar_image') . '/' . ($value->webinar_image ?? '')) }}">
                        ...
                        <div class="prog-img col-md-8">
                          ...
                          <a style="color:#000000;font-weight:bold;" href="{{ route('expert.website.workshop', ['id' => $value->id]) }}">
                              {{$value->webinar_title}}
                              </a>
                            </div>
                            <div class="prog-desc">
                            {{ substr($value->description, 0, 15) }}
                  ...
                  <div class="upcoming-block">
                    <div class="upcoming-list">
                      ...
                      <div class="upcomingList-con">
                        ...
                        <a href="{{ route('expert.website.program', ['id' => $value->id]) }}" class="text-black">
                         {{$value->title}}
                        </a>
                        </div>
