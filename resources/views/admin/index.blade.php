...
>
    ...
    <body>
                        ...
                        <div>
                            <div class="theme-colors">
                                ...
                                <div class="px-4 pb-3 text-muted fs-11">
                                    Note:If you want to change color Menu
                                    dynamically change from below Theme Primary
                                    color picker
                                </div>
                            </div>
                            <div class="theme-colors">
                                ...
                                <div class="px-4 pb-3 text-muted fs-11">
                                    Note:If you want to change color Header
                                    dynamically change from below Theme Primary
                                    color picker
                                </div>
                            </div>
                            ...
                            <div class="theme-colors">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        ></div>
                                        <div
                                            class="pickr-container-background"
                                        ></div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="page">
                ...
                <div class="main-header-container container-fluid">
                    ...
                    <div class="header-content-left">
                        ...
                        <div class="header-element header-search">
                            ...
                            <div
                                class="main-header-search ms-3 d-none d-lg-block my-auto"
                            >
                                <input
                                    class="form-control"
                    ...
                    <div class="header-content-right">
                        ...
                        <!-- Start::header-element -->
                        <div
                            class="header-element header-search d-block d-lg-none"
                        >
                            <!-- Start::header-link -->
                            <a
                                href="javascript:void(0);"
                        ...
                        <div class="header-element header-theme-mode">
                            ...
                            >
                                <span class="light-layout">
                                    ...
                                    <i
                                        class="fe fe-moonfe fe-moon header-link-icon align-middle"
                                    ></i>
                        ...
                        <div class="header-element header-fullscreen">
                            ...
                            >
                                ...
                                ></i>
                                <i
                                    class="fe fe-minimize full-screen-close header-link-icon d-none"
                                ></i>
                            </a>
                            <!-- End::header-link -->
                        </div>
                            ...
                            >
                                ...
                                >
                                    <li class="dropdown-item">
                                        <div class="d-flex align-items-start">
                                            <div class="pe-2">
                                                <span
                                                    class="avatar avatar-md bg-primary-gradient box-shadow-primary avatar-rounded"
                                                    ><i
                                                        class="ri-chat-4-line fs-18"
                                                    ></i
                                                ></span>
                                            </div>
                                            <div
                                            ...
                                            >
                                                ...
                                                <div>
                                                    <a
                                                        href="javascript:void(0);"
                                                        class="min-w-fit-content text-muted me-1 dropdown-item-close2"
                                                        ><i
                                                            class="ti ti-x fs-16"
                                                        ></i
                                                    ></a>
                                    ...
                                    <li class="dropdown-item">
                                        <div class="d-flex align-items-start">
                                            <div class="pe-2">
                                                <span
                                                    class="avatar avatar-md bg-secondary-gradient box-shadow-primary avatar-rounded"
                                                    ><i
                                    ...
                                    <li class="dropdown-item">
                                        <div class="d-flex align-items-start">
                                            <div class="pe-2">
                                                <span
                                                    class="avatar avatar-md bg-success-gradient box-shadow-primary avatar-rounded"
                                                    ><i
                                                        class="ri-shopping-cart-line fs-18"
                                                    ></i
                                                ></span>
                                            </div>
                                            <div
                                    ...
                                    <li class="dropdown-item">
                                        <div class="d-flex align-items-start">
                                            <div class="pe-2">
                                                <span
                                                    class="avatar avatar-md bg-warning-gradient box-shadow-primary avatar-rounded"
                                                    ><i
                                                        class="ri-refresh-fill fs-18"
                                                    ></i
                                                ></span>
                                            </div>
                                            <div
                                    ...
                                    <li class="dropdown-item">
                                        <div class="d-flex align-items-start">
                                            <div class="pe-2">
                                                <span
                                                    class="avatar avatar-md bg-info-gradient box-shadow-primary avatar-rounded"
                                                    ><i
                                                        class="ri-shopping-bag-fill fs-18"
                                                    ></i
                                                ></span>
                                            </div>
                                            <div
                                ...
                                <div class="p-3 empty-header-item1 border-top">
                                    <div class="d-grid">
                                        <a
                                            href="default-chat.html"
                                            class="btn text-muted p-0 border-0"
                                ...
                                <div class="p-5 empty-item1 d-none">
                                    <div class="text-center">
                                        ...
                                        >
                                            <i
                                                class="ri-notification-off-line fs-2"
                                            ></i>
                                        </span>
                        ...
                        <!-- Start::header-element -->
                        <div
                            class="header-element meassage-dropdown d-none d-xl-block"
                        >
                            <!-- Start::header-link|dropdown-toggle -->
                            <a
                                href="javascript:void(0);"
                            ...
                            >
                                <i
                                    class="fe fe-message-square header-link-icon"
                                ></i>
                                        ...
                                        <div class="d-flex align-items-start">
                                            ...
                                            >
                                                ...
                                                <div>
                                                    <a
                                                        href="javascript:void(0);"
                                                        class="min-w-fit-content text-muted me-1 dropdown-item-close3"
                                                        ><i
                                                            class="ti ti-x fs-16"
                                                        ></i
                                                    ></a>
                        ...
                        <div class="header-element cart-dropdown">
                            ...
                            >
                                <i
                                    class="fe fe-shopping-cart header-link-icon"
                                ></i>
                                <span
                                    class="badge rounded-pill bg-success cart-badge fw-normal"
                                    id="cart-icon-badge"
                                    >5</span
                                >
                            </a>
                            ...
                            >
                                    ...
                                    <li class="dropdown-item">
                                        ...
                                        >
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                >
                                                    <ul
                                                        class="header-product-item d-flex"
                                                    >
                                                        <li>White Set</li>
                                                    </ul>
                                                </div>
                                ...
                                <div class="p-5 empty-item d-none">
                                    <div class="text-center">
                                        ...
                                        >
                                            <i
                                                class="ri-shopping-cart-2-line fs-2"
                                            ></i>
                                        </span>
                                        <h6 class="fw-bold mb-1 mt-3">
                                            Your Cart is Empty
                                        </h6>
                                        <span
                                            class="mb-3 fw-normal fs-13 d-block"
                        ...
                        <div class="header-element profile-1">
                            ...
                            <a
                                href="#"
                                class="dropdown-toggle leading-none d-flex px-1"
                            ...
                            >
                                ...
                                <li>
                                    <a
                                        ...
                                        href="email.html"
                                        ><i
                                            class="ti ti-inbox fs-18 me-2 op-7"
                                        ></i
                                        >Inbox
                                        <span
                                            class="badge bg-success-transparent ms-auto"
                                            >25</span
                                        ></a
                                    >
                                </li>
                                <li>
                                    <a
                                        ...
                                        href="Timeline.html"
                                        ><i
                                            class="ti ti-clipboard-check fs-18 me-2 op-7"
                                        ></i
                                        >Task Manager</a
                                    >
                                </li>
                                <li>
                                    <a
                                        class="dropdown-item d-flex"
                                        href="emailservices.html"
                                        ><i
                                            class="ti ti-adjustments-horizontal fs-18 me-2 op-7"
                                        ></i
                                        >Settings</a
                                    >
                                </li>
                                <li>
                                    <a
                                        ...
                                        href="Faq.html"
                                        ><i
                                            class="ti ti-headset fs-18 me-2 op-7"
                                        ></i
                                        >Support</a
                                    >
                                </li>
                                <li>
                                    <a
                                        ...
                                        href="login.html"
                                        ><i
                                            class="ti ti-logout fs-18 me-2 op-7"
                                        ></i
                                        >Log Out</a
                                    >
                                </li>
                    ...
                    >
                        ...
                        <ul class="main-menu">
                            ...
                            <li class="slide has-sub">
                                ...
                                >
                                    <i
                                        class="fe fe-package side-menu__icon"
                                    ></i>
                                    <span class="side-menu__label"
                                        >Ui Elements</span
                                    >
                            ...
                            <li class="slide has-sub">
                                ...
                                >
                                    <i
                                        class="fe fe-pie-chart side-menu__icon"
                                    ></i>
                            ...
                            <li class="slide has-sub">
                                ...
                                >
                                    <i
                                        class="fe fe-file-text side-menu__icon"
                                    ></i>
                                    <span class="side-menu__label">Forms</span>
                                    <i
                                        class="fe fe-chevron-right side-menu__angle hor-rightangle"
                                    ></i>
                                    <span
                                        class="badge bg-success side-badge fs-11"
                                        >6</span
                                    >
                                </a>
                                <ul class="slide-menu child1">
                            ...
                            <li class="slide has-sub">
                                ...
                                >
                                    <i
                                        class="fe fe-sliders side-menu__icon"
                                    ></i>
                                    <span class="side-menu__label"
                                        >Nested Menu</span
                                    >
                            ...
                            <li class="slide has-sub">
                                ...
                                >
                                    <i
                                        class="fe fe-clipboard side-menu__icon"
                                    ></i>
                                    <span class="side-menu__label">Tables</span>
                                    <span
                                        class="badge bg-secondary side-badge fs-11"
                                        >3</span
                                    >
                                    <i
                                        class="fe fe-chevron-right side-menu__angle hor-rightangle"
                            ...
                            <li class="slide has-sub">
                                ...
                                >
                                    <i
                                        class="fe fe-settings side-menu__icon"
                                    ></i>
                                    <span class="side-menu__label"
                                        >Authentication</span
                                    >
                            ...
                            <li class="slide has-sub">
                                ...
                                >
                                    <i
                                        class="fe fe-map-pin side-menu__icon"
                                    ></i>
                            ...
                            <li class="slide">
                                <a href="icons.html" class="side-menu__item">
                                    <i
                                        class="fe fe-command side-menu__icon"
                                    ></i>
                ...
                <div class="container-fluid">
                    ...
                    >
                        ...
                        <div class="ms-auto pageheader-btn">
                            ...
                            >
                                <i class="fe fe-plus mx-1 align-middle"></i>Add
                                Account
                            </button>
                            <button
                                type="button"
                            ...
                            >
                                <i class="fe fe-log-in mx-1 align-middle"></i
                                >Export
                            </button>
                        </div>
                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <p class="text-muted mb-0">
                                                        ...
                                                        >
                                                            <i
                                                                class="ri-arrow-down-s-line bg-primary text-white rounded-circle fs-13 p-0 fw-semibold align-bottom"
                                                            ></i>
                                                            0.5%</span
                                                        >
                                                        last month
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <p class="text-muted mb-0">
                                                        ...
                                                        >
                                                            <i
                                                                class="ri-arrow-down-s-line bg-danger text-white rounded-circle fs-13 p-0 fw-semibold align-bottom"
                                                            ></i>
                                                            0.2%</span
                                                        >
                                                        last month
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div
                                        class="d-sm-flex mb-4 justify-content-between"
                                    >
                                        <div class="my-1">
                                        ...
                                        <div
                                            class="d-flex flex-wrap gap-2 my-1"
                                        >
                                            <div>
                                                <input
                                                    class="form-control form-control-sm h-35"
                                                    type="text"
                                    ...
                                    <div class="table-responsive deals-table">
                                        ...
                                        >
                                            <thead class="border-top">
                                                <tr>
                                                    <th
                                                        class="bg-transparent border-bottom-0 w-5 text-uppercase"
                                                    >
                                                        S.no
                                                    </th>
                                                    <th
                                                        class="bg-transparent border-bottom-0 text-uppercase"
                                                    >
                                                        Name
                                                    </th>
                                                    <th
                                            ...
                                            <tbody>
                                                <tr class="border-bottom">
                                                    <td
                                                        class="text-muted fs-15 fw-semibold"
                                                    >
                                                        01.
                                                    </td>
                                                    <td>
                                                        <div class="d-flex">
                                                            <img
                                                                class="avatar avatar-md rounded-circle mt-1"
                                                                alt="img"
                                                                src="../assets/images/faces/1.jpg"
                                                            />
                                                            <div
                                                                class="ms-2 mt-0 mt-sm-2 d-block"
                                                            >
                                                                <h6
                                                    ...
                                                    <td
                                                        class="text-success fs-15 fw-semibold"
                                                    >
                                                        Success
                                                    </td>
                                                    <td class="">
                                                        <div class="btn-list">
                                                            ...
                                                            >
                                                                <i
                                                                    class="ri-delete-bin-7-line lh-1"
                                                                ></i>
                                                            </a>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr class="border-bottom">
                                                    ...
                                                    <td
                                                        class="text-primary fs-15 fw-semibold"
                                                    >
                                                        Pending
                                                    </td>
                                                    <td class="">
                                                ...
                                                <tr class="border-bottom">
                                                    ...
                                                    <td
                                                        class="text-danger fs-15 fw-semibold"
                                                    >
                                                        Cancel
                                                    </td>
                                                    <td class="">
            ...
            <!-- Footer End -->
            <div
                class="offcanvas offcanvas-end offcanvas-sidebar overflow-auto"
                tabindex="-1"
                id="offcanvassidebar"
            >
                <!-- Sidebar-right -->
                <div class="card custom-card tab-heading shadow-none">
                    ...
                    <div class="card-body p-0">
                        <ul
                            class="nav nav-tabs my-3 nav-style-1 justify-content-center"
                            role="tablist"
                        >
                            <li class="nav-item">
                                <a
                            ...
                            <li class="nav-item">
                                <a
                                    ...
                                    href="#about32"
                                    aria-selected="false"
                                    ><i class="fe fe-users"></i> Contacts</a
                                >
                            </li>
                            <li class="nav-item">
                                <a
                        ...
                        <div class="tab-content">
                            <div
                                class="tab-pane show active text-muted p-0 rounded-0 border-bottom-0 border-end-0"
                                id="home31"
                                role="tabpanel"
                            >
                                <div class="card-body text-center">
                                    <div class="dropdown user-pro-body">
                                        <div class="">
                                            <img
                                                alt="user-img"
                                                class="avatar avatar-xl rounded-circle mx-auto text-center"
                                ...
                                <a
                                    class="dropdown-item d-flex border-bottom border-top"
                                    href="profile.html"
                                >
                                    <div class="d-flex">
                                        <i
                                            class="fe fe-user me-3 fs-20 text-muted"
                                        ></i>
                                        <div class="pt-1">
                                ...
                                >
                                    <div class="d-flex">
                                        <i
                                            class="fe fe-message-square me-3 fs-20 text-muted"
                                        ></i>
                                        <div class="pt-1">
                                ...
                                >
                                    <div class="d-flex">
                                        <i
                                            class="fe fe-mail me-3 fs-20 text-muted"
                                        ></i>
                                        <div class="pt-1">
                                ...
                                >
                                    <div class="d-flex">
                                        <i
                                            class="fe fe-settings me-3 fs-20 text-muted"
                                        ></i>
                                        <div class="pt-1">
                                            <h6 class="mb-0">
                                                Account Settings
                                ...
                                >
                                    <div class="d-flex">
                                        <i
                                            class="fe fe-power me-3 fs-20 text-muted"
                                        ></i>
                                        <div class="pt-1">
                            ...
                            <div
                                class="tab-pane text-muted p-0 rounded-0 overflow-auto border-end-0"
                                id="about32"
                                role="tabpanel"
                            >
                            ...
                            <div
                                class="tab-pane text-muted p-0 rounded-0 border-end-0"
                                id="service33"
                                role="tabpanel"
                            >
                                <a
                                    class="dropdown-item bg-white pd-y-10"
                                    href="javascript:void(0);"
                                >
                                    Account Settings
                                </a>
                                <div class="card-body py-2">
                                    <div
                                        class="form-check form-switch form-check-md my-2 mt-0"
                                    >
                                        <input
                                            class="form-check-input"
                                            type="checkbox"
                                    ...
                                    <div
                                        class="form-check form-switch form-check-md my-2"
                                    >
                                        <input
                                            class="form-check-input"
                                            type="checkbox"
                                    ...
                                    >
                                        ...
                                        <label
                                            class="form-check-label"
                                            for="flexSwitchCheckChecked6"
                                            >Show Email Notification</label
                                        >
                                    </div>
                                </div>
                                <a
                                ...
                                <div class="card-body py-2">
                                    ...
                                    >
                                        ...
                                        <label
                                            class="form-check-label"
                                            for="flexSwitchCheckChecked7"
                                            >Show User Online</label
                                        >
                                    </div>
                                    <div
                                        class="form-check form-switch form-check-md my-2"
                                    >
                                        ...
                                        <label
                                            class="form-check-label"
                                            for="flexSwitchCheckChecked8"
                                            >Website Notification</label
                                        >
                                    </div>
                                    <div
                                        class="form-check form-switch form-check-md my-2"
                                    >
                                        ...
                                        <label
                                            class="form-check-label"
                                            for="flexSwitchCheckChecked9"
                                            >Show Recent activity</label
                                        >
                                    </div>
                                    <div
                                        class="form-check form-switch form-check-md my-2"
                                    >
                                        ...
                                        <label
                                            class="form-check-label"
                                            for="flexSwitchCheckChecked10"
                                            >Logout Automatically</label
                                        >
                                    </div>
                                    <div
                                        class="form-check form-switch form-check-md my-2"
                                    >
                                        ...
                                        <label
                                            class="form-check-label"
                                            for="flexSwitchCheckChecked12"
                                            >Allow All Notifications</label
                                        >
                                    </div>
                                </div>
                            </div>
