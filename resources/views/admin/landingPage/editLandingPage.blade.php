   ...
   <div class="row">
      ...
      @if (session('success'))
         ...
         <div class="card">
            ...
            <div class="card-body">
               <form action="{{route('landingPage0')}}" method="POST" enctype="multipart/form-data"
                  id="basic-form">
                  @csrf
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <select class="form-control" id="webinar_id" name="webinar_id"  data-trigger name="choices-multiple-default" placeholder="">
                              ...
                              <option value="{{ $webiner->id }}" {{ ($webiner->id == $data->webinar_id) ? 'selected' : '' }}>
      ...
      <div class="row">
         <div class="col-lg-12">
            <div class="card">
               ...
               <div class="card-body">
                  <form action="{{route('landingPage')}}" method="POST" enctype="multipart/form-data"
                     id="basic-form">
                     @csrf
                     ...
                     <div class="row">
                        <div class="form-group">
                           ...
                           <textarea name="section1_des" class="ckeditor @error('section1_des') is-invalid @enderror"
                              id="ckeditor">{{ $data->section1_des }}</textarea>
                           @error('section1_des')
                           <span class="invalid-feedback form-invalid fw-bold" role="alert">
                           {{ $message }}
                           </span>
      ...
      <div class="row">
         <div class="col-lg-12">
            <div class="card">
               ...
               <div class="card-body">
                  <form action="{{route('update2secation')}}" method="POST" enctype="multipart/form-data"id="basic-form">
                     @csrf
                     <input type="hidden" name="id" id="id"value="{{$data->id}}">
                     <div class="row">
                        <div class="form-group col-md-6">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('landingPage3') }}" method="POST" enctype="multipart/form-data" id="basic-form">
                            @csrf
                            <input type="hidden" name="id" id="id" value="{{ $data->id }}">
                           @if($section3->isEmpty())
                           ...
                           @endif  
                            ...
                            <div id="Addsecation3Title">
                                    @foreach($section3 as $keys => $title)
                                   
                                        <div class="row secation3Remove mt-3 mb-3">
                                            <div class="form-group col-md-6">
                                                <label for="name" class="mt-2">Title<span class="text-danger">*</span></label>
                                                <input type="text" name="title[]" class="form-control" value="{{ $title->value }}" required>
                                            </div>
                                             <div class="form-group col-md-4" style="margin-top: 28px;">
                                                @if($keys > 0)
                                                   <button type="button" class="btn btn-danger removesecation3" data-id="{{$title->id}}"><i class="bi bi-trash-fill"></i></button>
                                                @endif
                                             </div>
                                        </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="section3_des" class="ckeditor @error('section3_des') is-invalid @enderror" id="ckeditor">{{ $data->section3_des }}</textarea>
                                @error('section3_des')
                                    <span class="invalid-feedback form-invalid fw-bold" role="alert">
                                        {{ $message }}
                                    </span>
      ...
      <div class="row">
         <div class="col-lg-12">
            <div class="card">
               ...
               <div class="card-body">
                  <form action="{{route('landingPage4')}}" method="POST" enctype="multipart/form-data"id="basic-form">
                     @csrf
                     <input type="hidden" name="id" id="id"value="{{$data->id}}">
                     <div class="row">
                        <div class="form-group col-md-6">
      ...
      <div class="row">
         <div class="col-lg-12">
            <div class="card">
               ...
               <div class="card-body">
                  <form action="{{route('landingPage5')}}" method="POST" enctype="multipart/form-data"id="basic-form">
                     @csrf
                     <input type="hidden" name="id" id="id"value="{{$data->id}}">
                     <div class="row">
                        ...
                        <div id="Addsecation5Title">
                              @foreach($section5 as $keys => $subtitle)
                              
                                    <div class="row secation5Remove mt-3 mb-3">
                                       <div class="form-group col-md-8">
                                          <label for="name" class="mt-2">Sub Title<span class="text-danger">*</span></label>
                                          <input type="text" name="subtitle[]" class="form-control" value="{{ $subtitle->value }}" required>
                                       </div>
                                       <div class="form-group col-md-4" style="margin-top: 28px;">
                                       @if($keys > 0)
                                       <button type="button" class="btn btn-danger removesecation5" data-id="{{$subtitle->id}}"><i class="bi bi-trash-fill"></i></button>
                                       @endif
                                       </div>
                                    </div>
                        ...
                        <div class="form-group col-md-5">
                           ...
                           @if (isset($data) && $data->section5_image_first)
                              <div class="mt-2">
                                    <p> Image:</p>
                                 <img src="{{ asset('uploads/'.$data->section5_image_first) }}" alt="Image" style="max-width: 100px;">
                              </div>
                           @endif
                        </div>
                        <div class="form-group col-md-5">
                           ...
                           <input type="file" name="section5_image_sec"
                              ...
                              @if (isset($data) && $data->section5_image_sec)
                              <div class="mt-2">
                                    <p> Image:</p>
                                 <img src="{{ asset('uploads/'.$data->section5_image_sec) }}" alt="Image" style="max-width: 100px;">
                              </div>
                           @endif
                        </div>
                        <div class="form-group col-md-5">
      ...
      <div class="row">
         <div class="col-lg-12">
            <div class="card">
               ...
               <div class="card-body">
                  <form action="{{route('landingPage6')}}" method="POST" enctype="multipart/form-data"id="basic-form">
                     @csrf
                     <input type="hidden" name="id" id="id"value="{{$data->id}}">
                     <div class="row">
                        <div class="form-group col-md-6">
      ...
      <div class="row">
         <div class="col-lg-12">
            <div class="card">
               ...
               <div class="card-body">
                  <form action="{{route('landingPage7')}}" method="POST" enctype="multipart/form-data"id="basic-form">
                     @csrf
                     <input type="hidden" name="id" id="id"value="{{$data->id}}">
                     <div class="row">
                        <div class="form-group col-md-6">
                        ...
                        <input type="text" name="subtitle[]"
                           ...
                           @if($section7->isEmpty())
                              <div class="row secation3Remove mt-3 mb-3">
                                 ...
                                 <div class="form-group col-md-4">
                                 <button id="secation7Title" type="button" class="btn btn-warning" style="margin-top: 27px;">SUB TITLE ADD MORE</button>
                                 </div>
                              </div>
                           @else
                           <div class="form-group mb-2 text-end">
                        ...
                        <div id="Addsecation7Title">
                                 @foreach($section7 as $keys => $sub)
                                
                                    <div class="row secation7Remove mt-3 mb-3">
                                       <div class="form-group col-md-8">
                                          <label for="name" class="mt-2">Sub Title<span class="text-danger">*</span></label>
                                          <input type="text" name="subtitle[]" class="form-control" value="{{ $sub->value }}" required>
                                       </div>
                                       <div class="form-group col-md-4" style="margin-top: 28px;">
                                       @if($keys > 0)
                                       <button type="button" class="btn btn-danger removesecation7" data-id="{{$sub->id}}"><i class="bi bi-trash-fill"></i></button>
                                       @endif
                                    </div>
                                    </div>
                        ...
                        <div class="form-group col-md-12">
                           ...
                           <textarea name="section7_des" class="ckeditor @error('section7_des') is-invalid @enderror"
                              id="ckeditor"> {{ $data->section7_des }}</textarea>
                           @error('section7_des')
                           <span class="invalid-feedback form-invalid fw-bold" role="alert">
                           {{ $message }}
                           </span>
