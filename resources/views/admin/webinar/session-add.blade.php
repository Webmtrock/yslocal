        ...
        <div class="card">
                        <div class="card-header ">
                            <div class="row">
                                ...
                                <h5>Create Webinar Session</h5>
                                </div>
                                <div class="col-xl-6 col-md-6">
                                    <div class="row float-end">
                                        <div class="col-xl-12 d-flex float-end">
                                        <a href="{{route('webinar.session_list',$id)}}" class="btn btn-primary btn-wave waves-effect waves-light me-2">
                                       Back </a>
                ...
                <div class="card-body">
                    <form  action="{{route('webinar.session_store',$id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
