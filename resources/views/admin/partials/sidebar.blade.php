        @php
            ...
            app('Illuminate\Contracts\Auth\Access\Gate')->abilities();
        @endphp
<!-- Start::app-sidebar -->
            ...
            <div class="main-sidebar" id="sidebar-scroll">
                ...
                <nav class="main-menu-container nav nav-pills flex-column sub-open">
                    ...
                    <ul class="main-menu">
                        ...
                        @endcan
                        @can('Event')
                        <li class="slide__category"><span class="category-name">Event Management</span></li>
                        <li class="slide has-sub">
                            <a href="javascript:void(0);" class="side-menu__item">
                            ...
                            <ul class="slide-menu child1 mega-menu">
                                <li class="slide side-menu__label1">
                                    <a href="javascript:void(0)">Events Lists</a>
                                </li>
                                <li class="slide">
                                    <a href="{{ route('webinars.index') }}" class="side-menu__item">Event Lists</a>
                                </li>
                                <li class="slide">
                                    <a href="{{ route('webinars.create') }}" class="side-menu__item">Add Event</a>
                                </li>
                            </ul>
                        </li>
                       ...
                       <!-- Start::slide -->
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child1 mega-menu">
                                ...
                                <li class="slide">
                                    <a href="{{route('coupon.index')}}" class="side-menu__item">Coupons Lists</a>
                                </li>
                                <li class="slide">
                        ...
                        @can('Landing Page')
                            ...
                            <li class="slide has-sub">
                                ...
                                <ul class="slide-menu child1 mega-menu">
                                    ...
                                    <li class="slide">
                                        <a href="{{ route('landingPage-lead') }}" class="side-menu__item">Landing Page Lead</a>
                                    </li>
                                    <!-- <li class="slide">
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child1 mega-menu">
                                ...
                                <li class="slide">
                                    <a href="{{route('experttheme-setting')}}" class="side-menu__item">Theme Setting</a>
                                </li>
                        ...
                        @if(auth()->user()->roles->pluck('name')->first() == 'Admin')
                        <li class="slide">
                            <a href="{{ route('site-setting.index') }}" class="side-menu__item">
                                <i class="fe fe-command side-menu__icon"></i>
                                <span class="side-menu__label">General Settings</span></a>
