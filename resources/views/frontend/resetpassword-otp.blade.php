...
<div class="container">
  <div class="row">
    ...
    @if (session('success'))
      ...
      <form class="login100-form validate-form" action="{{route('user.reset_password_verify')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <input type="hidden" value="{{@$phone}}" name="user_phone">
        <h2 style="margin: 20px;" >Reset Password Otp</h2>
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="form-cta">
               <button type="submit" class="yst-btn " style="width: 100%;">Otp Verify</button>
              </div>
            </div>
          </div>
